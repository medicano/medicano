...
Representa um estabelecimento de saúde pessoa jurídica. Referencia
...
\begin{table}[H]
  ...
  \begin{tabular}{p{3.8cm}p{2.5cm}p{5.2cm}}
    ...
    displayName        & String     & Nome do estabelecimento de saúde \\
    cnpj               & String     & CNPJ \\
...
um estabelecimento de saúde. Não possui plano de assinatura próprio.
...
de orientação baseados em LLMs para fins de auditoria
