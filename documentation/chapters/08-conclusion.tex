...
com orientação inteligente por chatbot, construída como
...
módulo de agendamentos, o painel do estabelecimento de saúde, o módulo
...
\begin{itemize}
  \item \textbf{Chatbot de orientação com LLM:} integração
  ...
  \item \textbf{Plataforma multilocatária:} arquitetura
        que suporta simultaneamente estabelecimentos de saúde com acesso
...
\begin{itemize}
  ...
  \item \textbf{Orientação restrita ao direcionamento
  ...
  \item \textbf{Cobertura de testes concentrada nos
        ...
        autenticação, regras de agendamento e orientação;
...
\begin{itemize}
  \item \textbf{Integração com gateway de pagamento:}
        ...
        cobrança recorrente, permitindo que estabelecimentos de saúde
  ...
  \item \textbf{Extração do módulo de orientação:}
        separação do chatbot de orientação em um
