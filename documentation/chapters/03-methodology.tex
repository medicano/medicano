...
MVP — autenticação, orientação por chatbot, busca e
...
\begin{table}[H]
  ...
  \begin{tabular}{cp{6cm}p{3.5cm}p{2cm}}
    ...
    1 & Setup do monorepo, configuração AWS,
      ...
      & 2 semanas \\
    \midrule
    2 & Módulo de estabelecimentos de saúde e profissionais,
        busca com filtros, perfil público
      & Busca de profissionais
      & 2 semanas \\
    \midrule
    3 & Chatbot de orientação com Vercel AI SDK,
    ...
    4 & Sistema de agendamentos, regras de
      ...
      & 2 semanas \\
    \midrule
    5 & Dashboard do estabelecimento de saúde, gestão de agenda,
        confirmação e cancelamento
      & Painel do estabelecimento de saúde
      & 2 semanas \\
    \midrule
    6 & Módulo de assinaturas, planos de estabelecimento de saúde
...
\begin{itemize}
  ...
  \item Cada nova funcionalidade ou correção é
        ...
        \texttt{feature/chat-orientacao} ou
...
agendamento e lógica de orientação. Fluxos secundários
