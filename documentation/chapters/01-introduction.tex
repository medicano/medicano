...
quanto aos profissionais e estabelecimentos de saúde. Do ponto de vista do
...
e estabelecimentos de saúde, a ausência de um sistema centralizado dificulta a
...
Essa realidade não se restringe aos estabelecimentos de saúde
convencionais. Profissionais de diversas áreas da saúde, como
médicos especialistas, psicólogos, psiquiatras, dentistas,
nutricionistas, fisioterapeutas e fonoaudiólogos, enfrentam
...
saúde e incorporando um chatbot de orientação inteligente baseado
...
saúde que conecte pacientes o estabelecimento de saúdes e profissionais de
diferentes especialidades, incorporando um chatbot de orientação
...
\begin{itemize}
  ...
  \item Desenvolver chatbot de orientação inteligente
  ...
  \item Desenvolver módulo de busca de profissionais
        e estabelecimentos de saúde por especialidade e localização
