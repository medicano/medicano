...
|-- clinics/            gestão de estabelecimentos de saúde
|-- professionals/      gestão de autônomos
|-- appointments/       agendamentos
|-- chat/               chatbot de orientação
...
\begin{itemize}
  \item \textbf{Paciente, estabelecimento de saúde e autônomo:}
  ...
  \item \textbf{Funcionário (atendente):}
        ...
        do escopo do estabelecimento de saúde vinculado. A estratégia
...
\subsection{Chatbot de Orientação}
\label{subsec:chat-frontend}

A interface do chatbot de orientação utiliza o Vercel
...
\begin{itemize}
  ...
  \item Extração do módulo de chatbot para um
        ...
        de orientação sem impacto no backend principal
